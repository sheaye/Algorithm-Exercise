...
public class Exercise4_2 {
    ...
    public static TreeNode reConstructBinaryTree(int[] pre, int[] in) {
        ...
        return resContractBinaryTree(pre, in, indexes);
    }

    private static TreeNode resContractBinaryTree(int[] pre, int[] in, HashMap<Integer, Integer> indexes) {
        ...
        if (pre.length > 1) {
            int targetIndex = indexes.get(element);
